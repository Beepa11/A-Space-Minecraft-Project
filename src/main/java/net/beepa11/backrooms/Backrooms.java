package net.beepa11.backrooms;

import dev.anvilcraft.lib.v2.registrum.Registrum;
import net.beepa11.backrooms.dimension.ModChunkGenerators;
import net.beepa11.backrooms.entity.ModEntities;
import net.beepa11.backrooms.entity.client.HowlerRenderer;
import net.beepa11.backrooms.entity.client.LifeformRenderer;
import net.beepa11.backrooms.registry.BRBlockEntities;
import net.beepa11.backrooms.registry.BRBlocks;
import net.beepa11.backrooms.sound.ModSounds;
