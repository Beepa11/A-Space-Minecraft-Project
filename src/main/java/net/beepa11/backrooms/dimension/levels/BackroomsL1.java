...
import static net.beepa11.backrooms.dimension.util.GenUtil.*;

import net.beepa11.backrooms.dimension.GenNoise;
import net.beepa11.backrooms.dimension.util.BackroomsLevel;
...
public class BackroomsL1 extends BackroomsLevel {
    ...
    public static void generateChunk(ChunkAccess chunk)
    {
        ...
        GenUtil.fillLayer(chunk, L1_FLOOR_LEVEL, BRBlocks.MOIST_CARPET.get());
        GenUtil.fillLayer(chunk, L1_CEILING_LEVEL, BRBlocks.YELLOW_CEILING_TILE.get());
            ...
            if(!isChunkInNoise(chunk.getPos().x,chunk.getPos().z, GenNoise.EmptyAreaNoise, 0.25)) {
                GenUtil.generateBasicWallsWithExtension(chunk, L1_FLOOR_LEVEL, L1_CEILING_LEVEL, BRBlocks.YELLOW_CHEVRON_WALLPAPER.get(), 3,  Blocks.STONE_BRICKS);
            }
        carve(chunk);
    }
