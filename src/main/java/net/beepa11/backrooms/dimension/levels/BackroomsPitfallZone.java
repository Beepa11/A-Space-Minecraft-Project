package net.beepa11.backrooms.dimension.levels;

import static net.beepa11.backrooms.dimension.util.GenUtil.isChunkInNoise;
import static net.beepa11.backrooms.dimension.util.GenUtil.random;

import net.beepa11.backrooms.dimension.GenNoise;
import net.beepa11.backrooms.dimension.util.GenUtil;
import net.beepa11.backrooms.registry.BRBlocks;
import net.beepa11.backrooms.utility.BlockFill;
...
public class BackroomsPitfallZone {
    ...
    private static void genRegular(ChunkAccess chunk)
    {
        ...
        GenUtil.fillLayer(chunk, PFZ_FLOOR_LEVEL, BRBlocks.MOIST_CARPET.get());
        GenUtil.fillLayer(chunk, PFZ_CEILING_LEVEL, BRBlocks.YELLOW_CEILING_TILE.get());
        ...
        if(!isChunkInNoise(chunk.getPos().x,chunk.getPos().z, GenNoise.EmptyAreaNoise, 0.25)) {
            GenUtil.generateBasicWallsWithExtension(chunk, PFZ_FLOOR_LEVEL, PFZ_CEILING_LEVEL, BRBlocks.YELLOW_CHEVRON_WALLPAPER.get(), 3,  Blocks.STONE_BRICKS);
        }
