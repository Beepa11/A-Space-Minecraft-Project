package net.beepa11.backrooms.dimension.util;

import net.beepa11.backrooms.dimension.BackroomsStructures;
...
public class GenUtil {
    ...
    public static void generateLights(ChunkAccess chunk, int layer)
    {
        ...
        for(int x = 0; x < 15; x = x + 4)
        {
            ...
            {
                chunk.setBlockState(chunkPos.getWorldPosition().offset(x,layer,z), BRBlocks.FLUORESCENT_CEILING_LIGHT.get().defaultBlockState(), true);
    ...
    {
        fillWall(chunk, 6, 3, 9, 12, floorLevel, ceilingLevel, BRBlocks.YELLOW_CHEVRON_WALLPAPER.get());
        fillWall(chunk, 3, 6, 12,9, floorLevel, ceilingLevel, BRBlocks.YELLOW_CHEVRON_WALLPAPER.get());
    }
